...
def distrib_init(mesh_dict, injection_dict, mode_dict):
    """
...
def One_step(liste_Y,n,segments_list,zone,mode_dict,mesh_dict,physics_consts_dict,t,E,dt):
    """
...
##############################################################################################################################
            ...
            coef_perte_energie=moy_E+np.random.random_sample()*sigma_E
...
##############################################################################################################################
    ...
    sect_eff=1e-18
##############################################################################################################################
    if np.random.random_sample()<dt*(d1+d2*Y_pot[1])*sect_eff*Y_pot[4] and Cond2==True:
        q==0
        #creer ion lent(maxwell 300k=0?)
...
##############################################################################################################################
    ...
    for n in range (N):
        x,y,z,vx,vy,vz=distrib_init(mesh_dict,injection_dict, mode_dict)
...
############################################################################################################################## 
    ...
    for i in range (nombre_tour_plein_debit):
        ...
        for n in range ((i+1)*nombre_max_injecte_par_tour):
            ...
            if liste_Y[n][1]!=1: 
                liste_Y[n][1]=0
                particule=One_step(liste_Y,n,segments_list,zone,mode_dict,mesh_dict,physics_consts_dict,t,E,dt)
