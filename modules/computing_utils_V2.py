...
from modules.physics_utils_V2 import compute_trajectory,get_VandE
from fenics import *

def main(integration_parameters_dict, injection_dict, mesh_dict, mode_dict, phi_dict, physics_consts_dict, first_time=False):
...
compute_trajectory(integration_parameters_dict, injection_dict, mesh_dict, mode_dict, segments_list, zone, E, physics_consts_dict, True)
            ...
            with open("CAS_TEST_V2_liste_param_testes.txt", "wb") as fp:
...
##############################################################################################################################    
    liste_couple_testes = np.array(liste_couple_testes)
